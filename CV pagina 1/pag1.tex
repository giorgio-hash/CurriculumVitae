...
\begin{figure}
    \quad \quad \begin{tikzpicture}
        ...
        \node[anchor=center] at (1.7,1.0) {\includegraphics[scale=.22]{../risorse/foto3.jpg}}
    \end{tikzpicture}
\end{figure}
...
\begin{itemize}
    ...
    \item Formazione ingegneristica: basi di crittografia, basi di sicurezza e protezione dati, ontologie, modelli predittivi e di ottimizzazione matematica, gestione aziendale e ICT, telecomunicazoni, teoria dell'informazione e della trasmissione codificata
\end{itemize}
...
\begin{itemize}
    ...
    \item Formazione ingegneristica: statistica e modelli stocastici, controllo automatico, elettronica, elettrotecnica, basi di economia e gestione del rischio
 \end{itemize}

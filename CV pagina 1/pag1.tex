...
\ThisCenterWallPaper{1.02}{cvbg4.jpg}
...
\begin{figure}
    \quad \quad \begin{tikzpicture}
        ...
        \node[anchor=center] at (2,1) {\includegraphics[scale=.4]{foto.png}}
    \end{tikzpicture}
\end{figure}
...
%    \quad \quad \begin{tikzpicture}
%        \clip (2,1)  circle (2.2cm) ;
%        \node[anchor=center] at (5.15,-6.32) {\includegraphics[scale=.258]{foto_stanchissimo.jpg}}
%    \end{tikzpicture}
%\end{figure}
...
\faCode \quad Docker Compose (base)

\faCode \quad PHP (ottimo)

\faCode \quad Python Flask (intermedio)

\faCode \quad Node.js (intermedio)

\faCode \quad Java Spring (intermedio)
